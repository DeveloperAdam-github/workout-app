...
<template>
  <div class="flex flex-col w-full h-full justify-center items-center">
    ...
    <div class="w-full flex justify-between my-4">
      <div class="h-14 w-24 flex items-center justify-center px-2 mx-2 rounded-xl transition-all duration-500 ease-in"
        :class="store.userDetails?.gender === 'male'
      ...
      <div class="h-14 w-24 flex items-center justify-center px-2 mx-2 rounded-xl transition-all duration-500 ease-in"
        :class="store.userDetails?.gender === 'female'
          ? 'bg-primary text-white'
          : 'bg-secondary text-black'
      ...
      <div class="h-14 w-24 flex items-center justify-center px-2 mx-2 rounded-xl transition-all duration-500 ease-in"
        @click="updateUserGender('other')" :class="store.userDetails?.gender === 'other'
          ? 'bg-primary text-white'
          : 'bg-secondary text-black'
          ">
        Other
